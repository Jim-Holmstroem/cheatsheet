...
\newcommand{\ddc}[3]{\left(\dd{#1}{#2}\right)_{#3}}
...
\section{Toolbox}
    ...
    \begin{equation}
        \ddc{x}{y}{z}\ddc{y}{z}{x}\ddc{z}{x}{y} = -1
    \end{equation}
    \begin{equation}
        \ddc{x}{y}{z}\ddc{y}{z}{x} = -\ddc{x}{z}{y} 
    \end{equation}

    $dS$ is an exact integral and thus only the start and end state needs
    to be calculated.

    \begin{equation}
        \ddc{u(x,y),v(x,y)}{x}{y} = \ddc{f(u,v)}{u}{v}\ddc{u(x,y)}{x}{y}+\ddc{f(u,v)}{v}{u}\ddc{v(x,y)}{x}{y}
    \end{equation}
